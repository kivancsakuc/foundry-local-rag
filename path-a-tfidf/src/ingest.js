/**
 * Ingestion script.
 * Reads all markdown documents from the shared knowledge-base folder,
...
async function ingest() {
  console.log("=== Summer School RAG – Document Ingestion ===\n");
  ...
  if (files.length === 0) {
    console.error("No markdown files found in the knowledge base");
    process.exit(1);
  }
